...
$curriculum = get_post_meta( $post->ID, 'curriculum', false)[0] ;
?>
    ...
    <div id="primary" class="content-area col-md-12">
        <main id="main" class="post-wrap" role="main">
                                        ...
                                        <div class="col-md-4">
                                            <div class="pcp-post-thumb-wrapper">
                                                <div class="sp-pcp-post-thumb-area">
                                                    <a href="<?php echo get_the_post_thumbnail_url( get_the_ID()); ?>" class="lightbox-gallery" data-title="<?php echo $post->post_title; ?>">
                                                        <img width="657" height="600" src="<?php echo get_the_post_thumbnail_url( get_the_ID()); ?>" class="attachment-full size-full">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                if($curriculum) {
                                                    ...
                                                    <div class="row" style="margin-top: 55px;">
                                                        <div class="col-md-12 text-center">
                                                            <a href="<?php echo $curriculum['guid']; ?>" target="_blank"
                                                               style="background: #FAFAFA; padding: 27px 15px 29px 15px; box-shadow: 0px 4px 14px 0px rgb(0 0 0 / 30%);"><img
                                                                        src="http://servando/wp-content/uploads/2022/01/surface1.png"
                                                                        style="width: 32px;"></a>
                                                        </div>
                                                    </div>
                                                    <?php
            ...
            <div id="sp-pcp-id-88" class="swiper-container info_overly sp-pcp-carousel-single nosostros" data-carousel="{ &quot;speed&quot;:600, &quot;items&quot;:7, &quot;spaceBetween&quot;:20, &quot;navigation&quot;:false, &quot;pagination&quot;: false, &quot;autoplay&quot;: true, &quot;autoplay_speed&quot;: 2000, &quot;loop&quot;: true, &quot;autoHeight&quot;: false, &quot;lazy&quot;:  true, &quot;simulateTouch&quot;: true, &quot;slider_mouse_wheel&quot;: false,&quot;allowTouchMove&quot;: true, &quot;slidesPerView&quot;: {&quot;lg_desktop&quot;: 3, &quot;desktop&quot;: 3, &quot;tablet&quot;: 2, &quot;mobile_landscape&quot;: 1, &quot;mobile&quot;: 1}, &quot;navigation_mobile&quot;: false, &quot;pagination_mobile&quot;: false, &quot;stop_onHover&quot;: true, &quot;enabled&quot;: true, &quot;prevSlideMessage&quot;: &quot;Previous slide&quot;, &quot;nextSlideMessage&quot;: &quot;Next slide&quot;, &quot;firstSlideMessage&quot;: &quot;This is the first slide&quot;, &quot;lastSlideMessage&quot;: &quot;This is the last slide&quot;, &quot;paginationBulletMessage&quot;: &quot;Go to slide {{index}}&quot; }">
                <!-- Slides wrapper -->
                <div class="swiper-wrapper">
                    ...
                    foreach ($obras as $obra)
                    {
                        ...
                        // Build out the carousel item
                        if(!in_array($obra['ID'], $obras_series ))
                        {
                        ?>
                            <div class="swiper-slide swiper-lazy swiper-lazy-loaded">
                                <div class="sp-pcp-post pcp-item-1032" data-id="1032">
                                    <div class="pcp-post-thumb-wrapper">
                                        <div class="sp-pcp-post-thumb-area">
                                            <a class="sp-pcp-thumb" href="<?php echo get_permalink($obra['ID']); ?>"
                                               target="_self">
                                                <img loading="lazy" src="<?php echo get_the_post_thumbnail_url( $obra['ID']); ?>"  alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <h2 class="sp-pcp-title">
                    ...
                    $grupo_de_obras = get_post_meta( get_the_ID(), 'grupo_de_obras', false );

                    if($grupo_de_obras){
                        // Loop through all of the results
                        foreach ($grupo_de_obras as $obra)
                        {
                            // Since we're doing this outside the loop,
                            // Build the apply the filters to the post's content
