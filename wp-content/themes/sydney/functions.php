...
function sydney_scripts() {
    ...
    wp_enqueue_style( 'alegreya-san-font', get_template_directory_uri() . '/fonts/alegreya-san-font/stylesheet.css' );
    ...
    wp_enqueue_script( 'swiper-scripts', get_template_directory_uri() . '/js/swiper_scripts.js', array('jquery'),'', true );
...
function bps_scripts_lightbox () {
    wp_enqueue_script('lightbox-js', get_stylesheet_directory_uri() . '/js/lightbox.js', array('jquery'));
    wp_enqueue_style('lightbox-css', get_stylesheet_directory_uri() . '/css/lightbox.css');
