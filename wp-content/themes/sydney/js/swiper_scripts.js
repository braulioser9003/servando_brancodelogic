jQuery(document).ready(function ($) {
    $('.info_image').hover(function () {
        $(this).find('.info_hover').removeClass('d-none');
    },function(){
        $(this).find('.info_hover').addClass('d-none');
    });

    if ($('.sp-pcp-carousel-single').length > 0) {
        $('.sp-pcp-carousel-single').each(function () {
