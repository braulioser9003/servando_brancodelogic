                ...
                <div class="ultp-upgrade-compare-table" style="overflow-x:auto;">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2"><?php _e('Table of Content advanced layouts', 'ultimate-post');?></td>
                                <td colspan="2"><i class="dashicons dashicons-no-alt table-icon"></i></td>
                                <td colspan="2"><i class="dashicons dashicons-yes table-icon"></i></td>
                            </tr>
                            <tr>
                                <td colspan="2"><?php _e('Table of Content Advanced Block Designs', 'ultimate-post');?></td>
                                <td colspan="2"><i class="dashicons dashicons-no-alt table-icon"></i></td>
                                <td colspan="2"><i class="dashicons dashicons-yes table-icon"></i></td>
                            </tr>
                            <tr>
                                <td colspan="2"><?php _e('Table of Content Hover Style', 'ultimate-post');?></td>
                                <td colspan="2"><i class="dashicons dashicons-no-alt table-icon"></i></td>
                                <td colspan="2"><i class="dashicons dashicons-yes table-icon"></i></td>
                            </tr>
                            <tr>
                                <td colspan="2"><?php _e('Sticky Table of Content', 'ultimate-post');?></td>
                                <td colspan="2"><i class="dashicons dashicons-no-alt table-icon"></i></td>
                                <td colspan="2"><i class="dashicons dashicons-yes table-icon"></i></td>
                            </tr>
                            <tr>
