 ...
 *
 * @wordpress-plugin
 * Plugin Name:       ElementsCSS Addons For Elementor
 * Plugin URI:        https://wordpress.org/plugins/css-for-elementor
 * Description:       New innovative Elementor Addons & Extended Elementor widgets at the same place. No coding knowledge required!
 * Version:           1.0.8.4
 * Author:            TheInnovs
 ...
 */
define( 'CSS_FOR_ELEMENTOR_VERSION', '1.0.8.4' );
			...
			<div class="row cssfe-review-notice">
				...
				<div class="col-md-11">
					...
					<ul>
						...
						<li id="cssfeReviewAlreadyDid"> <a href="#" ><span class="dashicons dashicons-smiley"></span> I already did</a></li>
						<li id="cssfeMaybeLater"> <a href=""><span class="dashicons dashicons-calendar-alt"></span> Maybe Later</a> </li>
						<li> <a href="https://docs.theinnovs.com" target="_blank"><span class="dashicons dashicons-editor-help"></span> I need help</a> </li>
						<li id="cssfeNeverShowAgain"><a href=""><span class="dashicons dashicons-no"></span> Never show again</a> </li>
					</ul>
				</div>
			</div>
		</div>
