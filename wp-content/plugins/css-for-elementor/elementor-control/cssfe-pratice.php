<?php
    ...
    add_action( 'elementor/element/section/section_advanced/after_section_end', 'cssfe_register_controls_partic' , 10, 2 );
	add_action( 'elementor/frontend/section/before_render', 'after_render_element', 10, 1 );

    function cssfe_register_controls_partic( $element, $args ) {

			$element->start_controls_section(
				'cssfe_particles_section',
				[
					'label' => __('<i class="dashicons dashicons-align-right" style="vertical-align: middle; color:#d30c5c"></i>Particles', 'css-for-elementor'),
		 ...
		 function after_render_element($element) {
