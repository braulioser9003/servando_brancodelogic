...
class Css_For_Elementor {
	...
	private function load_dependencies() {
		...
		/**
		 * Elemetor widgets class
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-css-for-elementor-widgets.php';

		/**
		 * Elementor widgets list
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-css-for-elementor-widget-list.php';
