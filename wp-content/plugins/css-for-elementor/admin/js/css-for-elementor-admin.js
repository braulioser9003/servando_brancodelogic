...
(function($) {
    ...
    $(document).on('click', '#cssfeReviewAlreadyDid, #cssfeNeverShowAgain', function(e) {
        e.preventDefault();
    ...
    $(document).on('click', '#cssfeMaybeLater, .cssfe-review .notice-dismiss', function(e) {
        e.preventDefault();
