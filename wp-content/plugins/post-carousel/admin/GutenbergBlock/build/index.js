...
icons.spspIcon = el('img', {
  src: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_0__.escapeAttribute)(smartPostShowGbScript.url + 'admin/GutenbergBlock/src/smart-post-show-icon.svg')
});
...
const DynamicShortcodeInput = _ref => {
  ...
  }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_1__.escapeHTML)(__('-- Select a Show --', 'post-carousel'))), shortcodelist.map(shortcode => {
...
registerBlockType("smart-post-show/shortcode", {
  title: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Smart Post Show", "post-carousel")),
  description: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Use Smart Post Show to insert a show in your page", "post-carousel")),
  icon: _shortcode_blockIcon__WEBPACK_IMPORTED_MODULE_1__["default"].spspIcon,
  category: "common",
  supports: {
    html: true
  },
  edit: props => {
    ...
    if (attributes.preview) {
      return el('div', {
        ...
        src: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeAttribute)(smartPostShowGbScript.url + "admin/GutenbergBlock/src/smart-post-show-block-preview.svg")
      }));
    }
    ...
    if (attributes.shortcodelist.length === 0) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, el('div', {
        ...
        src: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeAttribute)(smartPostShowGbScript.url + "admin/GutenbergBlock/src/smart-post-show-icon.svg")
      }), (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Smart Post Show", "post-carousel"))), el('div', {
        className: 'components-placeholder__instructions'
      }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("No shortcode found. ", "post-carousel")), el('a', {
        href: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeAttribute)(smartPostShowGbScript.link)
      }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Create a shortcode now!", "post-carousel"))))));
    }
    ...
    if (!attributes.shortcode || attributes.shortcode == 0) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
        ...
        className: 'components-placeholder__instructions'
      }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Select a Show", "post-carousel"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_shortcode_dynamicShortcode__WEBPACK_IMPORTED_MODULE_2__["default"], {
        attributes: attributes,
        shortcodeUpdate: shortcodeUpdate
      })));
    }
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
      ...
      block: "smart-post-show/shortcode",
      attributes: attributes
    }));
  },
