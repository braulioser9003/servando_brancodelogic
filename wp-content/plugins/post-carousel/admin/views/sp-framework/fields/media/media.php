		...
		public function render() {
			...
			$args = wp_parse_args(
				...
				array(
					...
					'preview'      => true,
					'library'      => array(),
					'button_title' => esc_html__( 'Upload', 'post-carousel' ),
					'remove_title' => esc_html__( 'Remove', 'post-carousel' ),
			...
			$placeholder = ( empty( $this->field['placeholder'] ) ) ? ' placeholder="' . esc_html__( 'No media selected', 'post-carousel' ) . '"' : '';
